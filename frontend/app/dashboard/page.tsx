...
export default function DashboardPage() {
  ...
  const stats = trackerStats ? [
    { label: 'Total Applications', value: trackerStats.total?.toString() || '0', change: '', up: true },
    { label: 'Pending', value: trackerStats.pending?.toString() || '0', change: '', up: true },
    { label: 'Shortlisted', value: trackerStats.shortlisted?.toString() || '0', change: '', up: true },
    { label: 'Interviewing', value: trackerStats.interviewing?.toString() || '0', change: '', up: true },
  ] : [
    { label: 'Total Applications', value: '0', change: '', up: true },
    { label: 'Pending', value: '0', change: '', up: true },
    { label: 'Shortlisted', value: '0', change: '', up: true },
    { label: 'Interviewing', value: '0', change: '', up: true },
  ];
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-[#f0f0f5] p-5">
            ...
            <div className="space-y-3">
              ...
              <Link href="/dashboard/interview" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition group">
                <div className="w-10 h-10 rounded-lg bg-green-50 flex items-center justify-center flex-shrink-0 group-hover:bg-green-100 transition">
              ...
              <Link href="/dashboard/jobs" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition group">
                <div className="w-10 h-10 rounded-lg bg-purple-50 flex items-center justify-center flex-shrink-0 group-hover:bg-purple-100 transition">
