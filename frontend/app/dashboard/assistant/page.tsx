  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-4xl mx-auto h-[calc(100vh-8rem)]">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-[#1e2a4a]">AI Career Assistant</h1>
      ...
      {/* Messages */}
      <div className="bg-white rounded-xl border border-[#e2e8f0] flex-1 overflow-y-auto p-4 mb-4" style={{ minHeight: '300px', maxHeight: 'calc(100vh - 280px)' }}>
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center py-12">
            <div className="w-16 h-16 bg-[#eef1f8] rounded-2xl flex items-center justify-center mb-4">
            ...
            <p className="text-[#1e2a4a] font-semibold mb-1">How can I help you?</p>
            ...
            <div className="flex flex-wrap gap-2 justify-center max-w-lg">
              {QUICK_PROMPTS.map((prompt) => (
                <button
                  ...
                  className="bg-[#eef1f8] hover:bg-[#dbe4ff] text-[#4f6ef7] text-xs font-medium px-3 py-2 rounded-xl transition border border-[#dbe4ff]"
                >
                  {prompt}
                </button>
              ))}
          ...
          <div className="space-y-4">
              ...
              <div key={msg.id} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-[85%] rounded-2xl px-4 py-3 ${
                  msg.role === 'user'
                    ...
                    : 'bg-[#f4f7fb] text-[#1e2a4a] rounded-bl-md'
                }`}>
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="bg-[#f4f7fb] rounded-2xl rounded-bl-md px-4 py-3">
      ...
      <div className="flex gap-3">
        <input
          ...
          className="flex-1 px-4 py-3 border border-[#e2e8f0] rounded-xl focus:ring-2 focus:ring-[#4f6ef7] focus:border-transparent text-sm bg-white text-[#1e2a4a] placeholder-[#9ca3af]"
          disabled={loading}
        />
        <button
          onClick={() => sendMessage()}
